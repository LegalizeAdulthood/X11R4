    ...
    unsigned char *pglyphBase;	/* start of array of glyphs */
{
	...
	int glx, gly;
	    ...
	    switch ((*pGC->pScreen->RectIn)(((mfbPrivGC *)(pGC->devPrivates[mfbGCPrivateIndex].ptr))->pCompositeClip, &cbox))
		...
		break;
	      case rgnPART:
		prgnClip = (* ((WindowPtr)pDrawable)->drawable.pScreen->RegionCreate)
		  (&cbox, REGION_NUM_RECTS(((mfbPrivGC *)(pGC->devPrivates[mfbGCPrivateIndex].ptr))->pCompositeClip));
