...
/* $Header: /andrew/X11/r3src/release/server/ddx/ibm/BSDrt/RCS/bsdKeymap.h,v 9.1 89/04/29 20:41:58 jeff Exp $ */
/* $Source: /andrew/X11/r3src/release/server/ddx/ibm/BSDrt/RCS/bsdKeymap.h,v $ */

#if !defined(lint) && !defined(LOCORE) && defined(RCS_HDRS)
static char *rcsidrtkeymap = "$Header: /andrew/X11/r3src/release/server/ddx/ibm/BSDrt/RCS/bsdKeymap.h,v 9.1 89/04/29 20:41:58 jeff Exp $";
#endif

#define	BSD_GLYPHS_PER_KEY	2
#define	BSD_MIN_KEY		7
#define	BSD_MAX_KEY		0x84
#define	BSD_CONTROL		0x11
#define	BSD_LEFT_SHIFT		0x12
#define	BSD_LOCK			0x14
#define	BSD_ALT_L		0x19
#define BSD_ALT_R		0x39
#define	BSD_ACTION		0x58
#define	BSD_RIGHT_SHIFT		0x59
#define BSD_NUM_LOCK		0x76

KeySym BSDmap[MAP_LENGTH*BSD_GLYPHS_PER_KEY] = {
/* BSD/RT Scan Code */	/* X11 Equivalent */	/* Key */
...
/* 0x19 */		XK_Alt_L,	XK_Meta_L,	/* left alt */
...
/* 0x39 */		XK_Alt_R,	XK_Meta_R,	/* right alt */
...
/* 0x5d */		0x5d,		NoSymbol,	/* no key */
/* 0x5e */		XK_F12,		NoSymbol,	/* f12 */
/* 0x5f */		XK_Pause,	NoSymbol,	/* scroll lock */
...
#ifdef ATHENA
/* 0x66 */		XK_Delete,	NoSymbol,	/* Backspace = Delete */
#else /* ATHENA */
