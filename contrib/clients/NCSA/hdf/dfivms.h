...
#define DFSDIgetslice(filename, winst, winend, data, ndims, dims, isfortran)  \
        _DFSDIgetslice(filename, winst, winend, data, ndims, dims, isfortran)
...
#define DFSDIputslice(winst, winend, data, ndims, dims, isfortran)  \
        _DFSDIputslice(winst, winend, data, ndims, dims, isfortran)
...
#define DFSDgetslice(filename, winst, winend, data, ndims, dims)  \
        _DFSDgetslice(filename, winst, winend, data, ndims, dims)
#define DFSDlastref()  \
        _DFSDlastref()
...
#define DFSDputslice(winst, winend, data, ndims, dims)  \
        _DFSDputslice(winst, winend, data, ndims, dims)
#define DFSDrestart()  \
        _DFSDrestart()
...
#define D2IAIMG(filename, image, xdim, ydim, fnlen) \
        _D2IAIMG(filename, image, xdim, ydim, fnlen)
#define D2IGDIM(filename, pxdim, pydim, pil, fnlen) \
        _D2IGDIM(filename, pxdim, pydim, pil, fnlen)
#define D2IGIMG(filename, image, xdim, ydim, fnlen) \
        _D2IGIMG(filename, image, xdim, ydim, fnlen)
#define D2REQIL(il) \
        _D2REQIL(il)
#define D2SDIMS(xdim, ydim, il) \
        _D2SDIMS(xdim, ydim, il)
#define DF24REQIL(il) \
        _DF24REQIL(il)
#define DF24SETDIMS(xdim, ydim, il) \
        _DF24SETDIMS(xdim, ydim, il)
...
#define d2iaimg_(filename, image, xdim, ydim, fnlen) \
        _d2iaimg_(filename, image, xdim, ydim, fnlen)
#define d2igdim_(filename, pxdim, pydim, pil, fnlen) \
        _d2igdim_(filename, pxdim, pydim, pil, fnlen)
#define d2igimg_(filename, image, xdim, ydim, fnlen)
        _d2igimg_(filename, image, xdim, ydim, fnlen)
#define d2reqil_(il) \
        _d2reqil_(il)
#define d2sdims_(xdim, ydim, il) \
        _d2sdims_(xdim, ydim, il)
#define df24reqil_(il) \
        _df24reqil_(il)
#define df24setdims_(xdim, ydim, il) \
        _df24setdims_(xdim, ydim, il)
