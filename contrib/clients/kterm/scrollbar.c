/*
 *	$XConsortium: scrollbar.c,v 1.2 89/12/15 11:53:24 kit Exp $
 *	$Header: scrollbar.c,v 1.2 89/12/15 11:53:24 kit Exp $
 */
...
#ifndef lint
static char rcs_id[] = "$XConsortium: scrollbar.c,v 1.2 89/12/15 11:53:24 kit Exp $";
static char kterm_id[] = "$Header: scrollbar.c,v 1.2 89/12/15 11:53:24 kit Exp $";
#endif	/* lint */
