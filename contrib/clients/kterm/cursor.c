 ...
 *	$Header: /usr2/yoshi/kagotani/src/X/kterm/kterm.3.2.0/RCS/cursor.c,v 1.1 89/11/21 21:01:19 kagotani Rel $
 */

#ifndef lint
static char *rcsid_cursor_c = "$XConsortium: cursor.c,v 1.5 88/10/07 14:16:09 swick Exp $";
static char *ktermid_cursor_c = "$Header: /usr2/yoshi/kagotani/src/X/kterm/kterm.3.2.0/RCS/cursor.c,v 1.1 89/11/21 21:01:19 kagotani Rel $";
#endif	/* lint */
...
static char kterm_id[] = "$Header: /usr2/yoshi/kagotani/src/X/kterm/kterm.3.2.0/RCS/cursor.c,v 1.1 89/11/21 21:01:19 kagotani Rel $";
#endif	/* lint */
...
register SavedCursor *sc;
{
	...
	term->flags &= ~(BOLD|INVERSE|UNDERLINE|ORIGIN);
	  /* sc->row stores an absolute row position, so clear ORIGIN flag. */
