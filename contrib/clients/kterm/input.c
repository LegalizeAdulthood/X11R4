 ...
 *	$Header: /usr2/yoshi/kagotani/src/X/kterm/kterm.3.2.0/RCS/input.c,v 1.1 89/11/21 21:01:27 kagotani Rel $
 */

#ifndef lint
static char *rcsid_input_c = "$XConsortium: input.c,v 1.5 88/09/06 17:08:05 jim Exp $";
static char *ktermid_input_c = "$Header: /usr2/yoshi/kagotani/src/X/kterm/kterm.3.2.0/RCS/input.c,v 1.1 89/11/21 21:01:27 kagotani Rel $";
#endif	/* lint */
...
static char kterm_id[] = "$Header: /usr2/yoshi/kagotani/src/X/kterm/kterm.3.2.0/RCS/input.c,v 1.1 89/11/21 21:01:27 kagotani Rel $";
#endif	/* lint */
...
#define STRBUFSIZE 100
	...
	if (keycode>>8 == 4 && keycode & 0x80) {
		if (term->flags & EUC_KANJI) {
			...
			strbuf[3] = strbuf[0] & 0x7f;
			strbuf[0] = ESC;
			strbuf[1] = '(';
			strbuf[2] = 'I';
			strbuf[4] = ESC;
			strbuf[5] = '(';
			strbuf[6] = screen->gsets[0];
			nbytes = 7;
		}
	}
#else	KANJI
