 ...
 *	$Header: /usr2/yoshi/kagotani/src/X/kterm/kterm.3.2.0/RCS/button.c,v 1.3 89/11/21 21:02:38 kagotani Rel $
 */
...
static char kterm_id[] = "$Header: /usr2/yoshi/kagotani/src/X/kterm/kterm.3.2.0/RCS/button.c,v 1.3 89/11/21 21:02:38 kagotani Rel $";
#endif	/* lint */
#include <X11/Xos.h>
#include <X11/Xlib.h>
#include <X11/Xatom.h>
...
int *format;
{
	...
	ws = (n > 256) ? (wchar_t *)XtMalloc((n + 1) * sizeof(wchar_t)) : wbuf;
