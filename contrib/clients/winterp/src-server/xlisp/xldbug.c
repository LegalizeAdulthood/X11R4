...
*
* File:         xldebug.c
* RCS:          $Header: xldbug.c,v 1.3 89/11/25 05:16:32 mayer Exp $
* Description:  xlisp debugging support
* Author:       David Michael Betz; Niels Mayer
* Created:      
* Modified:     Sat Nov 25 05:16:16 1989 (Niels Mayer) mayer@hplnpm
* Language:     C
* Package:      N/A
...
********************************************************************************
*/
static char rcs_identity[] = "@(#)$Header: xldbug.c,v 1.3 89/11/25 05:16:32 mayer Exp $";
     ...
     char *hdr,*cmsg,*emsg; LVAL arg; int cflag;
{
  ...
  for (type = 0; type == 0; ) {
     ...
     * by XtNextEvent(). Note that XtNextEvent() ignores the aforementioned
