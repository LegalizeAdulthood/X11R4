...
*
* File:         wc_ArrowB.c
* RCS:          $Header: wc_ArrowB.c,v 1.1 89/11/25 04:33:56 mayer Exp $
* Description:  XM_ARROW_BUTTON_WIDGET_CLASS/XM_ARROW_BUTTON_GADGET_CLASS
* Author:       Niels Mayer, HPLabs
* Created:      Fri Oct 27 21:36:45 1989
* Modified:     Sat Nov 25 04:33:46 1989 (Niels Mayer) mayer@hplnpm
* Language:     C
* Package:      N/A
...
********************************************************************************
*/
static char rcs_identity[] = "@(#)$Header: wc_ArrowB.c,v 1.1 89/11/25 04:33:56 mayer Exp $";
