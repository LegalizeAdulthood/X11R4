...
*
* File:         wc_Label.c
* RCS:          $Header: wc_Label.c,v 1.1 89/11/25 04:44:10 mayer Exp $
* Description:  XM_LABEL_WIDGET_CLASS/XM_LABEL_GADGET_CLASS
* Author:       Niels Mayer, HPLabs
* Created:      Sat Oct 28 01:24:54 1989
* Modified:     Sat Nov 25 04:43:59 1989 (Niels Mayer) mayer@hplnpm
* Language:     C
* Package:      N/A
...
********************************************************************************
*/
static char rcs_identity[] = "@(#)$Header: wc_Label.c,v 1.1 89/11/25 04:44:10 mayer Exp $";
