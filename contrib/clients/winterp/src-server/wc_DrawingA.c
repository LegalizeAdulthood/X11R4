...
*
* File:         wc_DrawingA.c
* RCS:          $Header: wc_DrawingA.c,v 1.1 89/11/25 04:36:54 mayer Exp $
* Description:  XM_DRAWING_AREA_WIDGET_CLASS
* Author:       Niels Mayer, HPLabs
* Created:      Fri Oct 27 22:22:38 1989
* Modified:     Sat Nov 25 04:36:30 1989 (Niels Mayer) mayer@hplnpm
* Language:     C
* Package:      N/A
...
********************************************************************************
*/
static char rcs_identity[] = "@(#)$Header: wc_DrawingA.c,v 1.1 89/11/25 04:36:54 mayer Exp $";
...
LVAL Xm_Drawing_Area_Widget_Class_Method_ADD_CALLBACK()
{
  ...
  extern void Wcb_XmDrawingAreaCallbackStruct_Callbackproc(); /* w_callbacks.c */
  return(Wcb_Meta_Method_Add_Callback(Wcb_XmDrawingAreaCallbackStruct_Callbackproc, FALSE));
}
...
LVAL Xm_Drawing_Area_Widget_Class_Method_SET_CALLBACK()
{
  extern LVAL Wcb_Meta_Method_Add_Callback(); /* w_callbacks.c */
  extern void Wcb_XmDrawingAreaCallbackStruct_Callbackproc(); /* w_callbacks.c */
  return (Wcb_Meta_Method_Add_Callback(Wcb_XmDrawingAreaCallbackStruct_Callbackproc, TRUE));
}
