/*
	...
	This module was authored by A. Nowatzyk and was publicly
	distributed on a comp.sources newsgroup.  The original copyright
	notice and the unaltered source code immediately follows our own
	standard copyright notice.  To our knowledge all explicitly
	stated terms of our own copyright notice, other than identification
	of the author, are applicable to this module.
