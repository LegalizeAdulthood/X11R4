/*
* $Header: MenuItemI.h,v 1.8 87/12/04 10:58:49 swick Exp $
*/
...
/*
 *
 *  A few definitions to make MenuItem.c easier to read.
 *   
 */
...
#define ComWcallbackList                 cbw->menuitem.callback_list
#define ComWcallback                     cbw->menuitem.callback
#define ComWclosure                      cbw->menuitem.closure
#define ComWhighlightGC                  cbw->menuitem.highlight_GC
#define ComWeraseHighGC                  cbw->menuitem.erase_highlight_GC
#define ComWinverseGC                    cbw->menuitem.inverse_GC
#define ComWinverseTextGC                cbw->menuitem.inverse_text_GC
#define ComWhighlightThickness           cbw->menuitem.highlight_thickness
#define ComWset                          cbw->menuitem.set
#define ComWhighlighted                  cbw->menuitem.highlighted
#define ComWdisplaySet                   cbw->menuitem.display_set
#define ComWdisplayHighlighted           cbw->menuitem.display_highlighted

#define XtCBField(cbw,field)  cbw->menuitem.field
