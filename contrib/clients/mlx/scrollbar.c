/*
 *	$Header: scrollbar.c,v 1.2 89/12/15 11:55:50 kit Exp $
 */
...
#include "ptyx.h"
#include "data.h"
#include <X11/Scroll.h> /* should come from Xaw/Scrollbar.h at some point */
#include "error.h"

extern void bcopy();

#ifndef lint
static char rcs_id[] = "$Header: scrollbar.c,v 1.2 89/12/15 11:55:50 kit Exp $";
#endif	/* lint */
