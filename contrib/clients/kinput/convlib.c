...
/*
 * This library is for languages that need a complex input method
 * (such as Japanese).
 ...
 * So, you can easily input these languages with this library (if you have
...
#ifndef lint
static char	*rcsid = "$Id: convlib.c,v 2.4 89/10/18 19:59:36 ishisone Exp $";
#endif
...
#define nalloc	2
	...
	if (ndisp == 0) {
		/* it's first time, so a context should also be made */
