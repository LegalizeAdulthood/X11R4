/* $Id: cconv.h,v 8.0 89/10/27 20:27:20 ishisone Rel $ */
/*
...
extern wchar_t *ccGetModePrompt(ccBuf);
...
extern void ccContextSet(ccBuf, wchar_t *);
extern void ccContextGet(ccBuf, wchar_t *);
...
extern wchar_t *ccGetModePrompt();
