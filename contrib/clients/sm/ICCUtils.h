...
$Header: ICCUtils.h,v 3.0 89/11/20 09:24:44 mikew Exp $
...
extern Status   SaveYourself();
extern Status   GetTopLevelWindows();
extern Boolean  CheckForProtocol();
extern Status   SendSaveYourSelf();
