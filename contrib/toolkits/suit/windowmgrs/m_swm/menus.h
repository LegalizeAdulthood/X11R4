/*
 *      Original Source: ./contrib/windowmgrs/twm/menus.h
 *
 * Changes
...
#define SWM_ROOT	"bLoB_GoOp"	/* my private root menu */
#define SWM_WINDOWS	"SwmWindows"	/* for f.menu "SwmWindows" */
...
typedef struct MenuItem
{
    ...
    int func;			/* swm built in function */
