...
typedef struct _StButtonClass {int wink;} StButtonClassPart;

typedef struct _StButtonClassRec {
    ...
    StButtonClassPart            stButton_class;
} StButtonClassRec;

extern StButtonClassRec stButtonClassRec;

typedef struct {int yuma;} StButtonPart;

typedef struct _StButtonRec {
    CorePart                core;
