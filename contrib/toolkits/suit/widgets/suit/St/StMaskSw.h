...
#ifndef _StMaskedSwitch_h
#define _StMaskedSwitch_h

/***********************************************************************
 *
 * SUIT Masked Switch Widget
 *
 ***********************************************************************/
...
#define StNpixmapForSet		"stPixmapForSet"
#define StNpixmapForUnset	"stPixmapForUnset"

extern WidgetClass	stMaskedSwitchWidgetClass;

typedef struct _StMaskedSwitchClassRec	*StMaskedSwitchWidgetClass;
typedef struct _StMaskedSwitchRec	*StMaskedSwitchWidget;

#endif _StMaskedSwitch_h
