...
#ifndef _StRadioSwitchP_h
#define _StRadioSwitchP_h

#include <St/StRadioSw.h>
#include <St/StMaskSwP.h>

typedef struct _StRadioSwitchClass {int i_am_happy;} StRadioSwitchClassPart;

typedef struct _StRadioSwitchClassRec {
    ...
    StRadioSwitchClassPart       stRadioSw_class;
} StRadioSwitchClassRec;

extern StRadioSwitchClassRec stRadioSwitchClassRec;
...
typedef struct _StRadioSwitchRec {
    CorePart                core;
    ...
    StRadioSwitchPart       stRadioSw;
} StRadioSwitchRec;

#endif _StRadioSwitchP_h
