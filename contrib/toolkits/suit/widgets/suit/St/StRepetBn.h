...
#ifndef _StRepeatButton_h
#define _StRepeatButton_h

/***********************************************************************
 *
 * SUIT Repeat Button Widget
 *
 ***********************************************************************/
...
extern WidgetClass	stRepeatButtonWidgetClass;

typedef struct _StRepeatButtonClassRec	*StRepeatButtonWidgetClass;
typedef struct _StRepeatButtonRec	*StRepeatButtonWidget;

#endif _StRepeatButton_h
