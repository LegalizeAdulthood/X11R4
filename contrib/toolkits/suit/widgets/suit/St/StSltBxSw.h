...
#ifndef _StSelectBoxSwitch_h
#define _StSelectBoxSwitch_h

/***********************************************************************
 *
 * SUIT Selection-Box Switch Widget 
 *
 ***********************************************************************/
...
extern WidgetClass	stSelectBoxSwitchWidgetClass;

typedef struct _StSelectBoxSwitchClassRec	*StSelectBoxSwitchWidgetClass;
typedef struct _StSelectBoxSwitchRec		*StSelectBoxSwitchWidget;

#endif _StSelectBoxSwitch_h
