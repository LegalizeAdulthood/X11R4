/*
 *      Original Source: ./lib/Xaw/Label.h
 *
 * Changes
...
/* Resources:
 ...
 backgroundBitmap    Pixmap		Pixmap		None
 ...
 marginY             StCMLabelargin     Dimension       0
...
#define StNlabel		"stLabel"
#define StNbitmap		"stBitmap"
#define StNjustify		"stJustify"
#define StNdrawable		"stDrawable"
#define StNmarginX		"stMarginX"
#define StNmarginY		"stMarginY"

#define StCLabelMargin		"StLabelMargin"

extern WidgetClass	stLabelWidgetClass;

typedef struct _StLabelClassRec	*StLabelWidgetClass;
typedef struct _StLabelRec	*StLabelWidget;
