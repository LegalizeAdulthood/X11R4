...
#ifndef _StSimpleButtonP_h
#define _StSimpleButtonP_h

#include <St/StSimplBn.h>
#include <St/StSimplSwP.h>

typedef struct _StSimpleButtonClass {int i_am_happy;} StSimpleButtonClassPart;

typedef struct _StSimpleButtonClassRec {
...
} StSimpleButtonClassRec;

extern StSimpleButtonClassRec stSimpleButtonClassRec;

typedef struct {int i_am_very_happy;} StSimpleButtonPart;

typedef struct _StSimpleButtonRec {
    CorePart		core;
