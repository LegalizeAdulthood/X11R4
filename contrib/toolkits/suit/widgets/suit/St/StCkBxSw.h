...
#ifndef _StCheckBoxSwitch_h
#define _StCheckBoxSwitch_h

/***********************************************************************
 *
 * SUIT Check-Box Switch Widget 
 *
 ***********************************************************************/
...
extern WidgetClass	stCheckBoxSwitchWidgetClass;

typedef struct _StCheckBoxSwitchClassRec	*StCheckBoxSwitchWidgetClass;
typedef struct _StCheckBoxSwitchRec		*StCheckBoxSwitchWidget;

#endif _StCheckBoxSwitch_h
