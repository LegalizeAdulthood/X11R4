...
#ifndef _StPopupSheetButton_h
#define _StPopupSheetButton_h

/***********************************************************************
 *
 * SUIT Popup-Sheet Button Widget
 *
 ***********************************************************************/
...
extern WidgetClass	stPopupSheetButtonWidgetClass;

typedef struct _StPopupSheetButtonClassRec	*StPopupSheetButtonWidgetClass;
typedef struct _StPopupSheetButtonRec		*StPopupSheetButtonWidget;

#endif _StPopupSheetButton_h
