...
/*
 *
 *  A few definitions to make StPictrialSwitch.c easier to read.
 *   
 */
...
#define PriWborderGC                      bw->stPicSw.border_GC
#define PriWbackgroundGC                  bw->stPicSw.background_GC
#define PriWinsideGC                      bw->stPicSw.inside_GC
