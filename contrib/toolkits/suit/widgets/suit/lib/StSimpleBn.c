...
/*
 * StSimpleButton.c - SUIT Simple Button widget
 *
 */
...
StSimpleButtonClassRec stSimpleButtonClassRec = {
  {
    (WidgetClass) SuperClass,		/* superclass		  */	
    "StSimpleButton",	      		/* class_name		  */
    sizeof(StSimpleButtonRec),		/* size			  */
...
WidgetClass stSimpleButtonWidgetClass = (WidgetClass)&stSimpleButtonClassRec;
...
static void Initialize(request, new)
    Widget request, new;
{
    StSimpleButtonWidget bw = (StSimpleButtonWidget) new;
...
{
    StSimpleButtonWidget cw = (StSimpleButtonWidget) current;
    StSimpleButtonWidget bw = (StSimpleButtonWidget) new;
...
{
    StSimpleButtonWidget bw = (StSimpleButtonWidget) w;
