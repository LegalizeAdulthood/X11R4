...
#ifndef _Xcu_Button_h
#define _Xcu_Button_h
...
extern WidgetClass     xcuButtonWidgetClass;

typedef struct _XcuButtonClassRec   *XcuButtonWidgetClass;
typedef struct _XcuButtonRec        *XcuButtonWidget;
