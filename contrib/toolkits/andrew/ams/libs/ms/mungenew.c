 ...
 *         Copyright IBM Corporation 1988,1989 - All Rights Reserved      *
  *        For full copyright information see:'andrew/config/COPYRITE'     *
  \* ********************************************************************** */
/*
  $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/ams/libs/ms/RCS/mungenew.c,v 2.22 89/08/08 14:45:08 ghoti Exp $
  $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/ams/libs/ms/RCS/mungenew.c,v $
  */
#include <andyenv.h>
#include <ms.h>
#include <sys/stat.h>
...
extern char    *malloc(), *rindex(), home[], Me[], *PersonalMailCollectionCommand, *GetPersonalMailbox(), *getprofile(), *getenv();
...
int *NumGood, *NumBad, *NumLocks, *resultcode, *FirstError, *NumInProgress, EliErrBufLim;
{
    ...
    *NumBad = *NumGood = *NumInProgress = *NumLocks = *FirstError = *resultcode = 0;
	...
	s = rindex(SpecFileName, '/');
	if (s) {
	    strcpy(++s, DEFAULTFLAMESFILENAME);
	    if (!access(SpecFileName, R_OK)) {
