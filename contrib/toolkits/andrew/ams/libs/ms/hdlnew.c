...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/ams/libs/ms/RCS/hdlnew.c,v 2.51 89/10/20 14:59:27 bobg Exp $ */
/* $ACIS: $ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/ams/libs/ms/RCS/hdlnew.c,v $ */

#ifndef lint
static char    *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/ams/libs/ms/RCS/hdlnew.c,v 2.51 89/10/20 14:59:27 bobg Exp $ ";
...
extern char    *malloc(), *rindex(), *index(), *getenv(), *sys_errlist[];
...
Boolean         AllowRenaming;
{
    ...
    if (!AllowRenaming
	 ...
	 || Msg->WeFiddled
	 || (wasntRenamed = RenameEvenInVice(currentMessageFile, NewFileName))) {
