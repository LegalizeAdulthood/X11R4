...
\* ********************************************************************** */
/*
$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/ams/libs/ms/RCS/rebldmuf.c,v 2.13 89/07/13 11:14:09 cfe Exp $
$Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/ams/libs/ms/RCS/rebldmuf.c,v $
*/
#include <stdio.h>
#include <ms.h>
#include <sys/stat.h>
...
extern char *index(), *StripWhiteEnds(), *fixDate();
