...
\* ********************************************************************** */
/*
$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/ams/libs/ms/RCS/submsg.c,v 2.10 89/07/14 17:35:38 cfe Exp $
$Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/ams/libs/ms/RCS/submsg.c,v $
*/
#include <ms.h>
#include <stdio.h>
#include <ctype.h>
...
extern char     Me[], *MyPrettyAddress, *BCCto, home[], *malloc(), *NextAddress();
