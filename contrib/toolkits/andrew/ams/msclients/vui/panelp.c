...
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/ams/msclients/vui/RCS/panelp.c,v 1.15 89/07/21 17:45:33 cfe Exp $ */
...
GetStringFromUser(prompt, output, length)
char *prompt, *output;
int length;
{
    if (Interactive) {
