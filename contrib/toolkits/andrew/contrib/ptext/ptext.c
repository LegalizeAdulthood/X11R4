...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/contrib/ptext/RCS/ptext.c,v 1.3 89/08/20 00:48:46 zs01 Exp $ */
/* $ACIS:ptext.c 1.2$ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/contrib/ptext/RCS/ptext.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/contrib/ptext/RCS/ptext.c,v 1.3 89/08/20 00:48:46 zs01 Exp $";
#endif /* lint */
...
long backCopyWord(pt, from, to, buffer)
struct ptext *pt;
long from,to;
char buffer[];
{
...
struct keywd *lookupKeyword(dict, word)
struct keywd *dict;
char *word;
{
    struct keywd *k;
...
void stylizekeyword(self, posn, len)
struct ptext *self;
long posn, len;
{
