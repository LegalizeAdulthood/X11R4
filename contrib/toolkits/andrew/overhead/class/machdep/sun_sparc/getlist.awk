...
#  want[definer["_class_Header"]] = "Y";
  ...
  if (definer["_getpwuid"] != "") want[definer["_getpwuid"]] = "Y";
  if (definer["_clntudp_create"] != "") want[definer["_clntudp_create"]] = "Y";
  if (definer["_authnone_create"] != "") want[definer["_authnone_create"]] = "Y";
  if (definer["_authunix_create"] != "") want[definer["_authunix_create"]] = "Y";
