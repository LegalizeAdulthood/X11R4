...
\* ********************************************************************** */
/* $Header: /afs/.andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/overhead/class/lib/RCS/class.h,v 2.15 89/09/26 09:15:01 jhh Exp $ */
...
/* 
 * Please remove this once AIX has a real C compiler.  %%%%
 * Thank, pgc.
 */
extern void free();
