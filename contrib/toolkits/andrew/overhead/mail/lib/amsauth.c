...
static char rcsid[] = "$Header: amsauth.c,v 1.1 89/12/05 21:15:13 xguest Exp $";
...
{/* Like FindPrimaryCell, except that it returns a pointer to the cell that AMS thinks is the user's home, if there is one.
