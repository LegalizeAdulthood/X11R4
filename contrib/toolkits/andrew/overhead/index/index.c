...
\* ********************************************************************** */
/* $Header: /afs/.andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/overhead/index/RCS/index.c,v 2.3 89/02/10 23:14:23 ghoti Exp $ */
/* $ACIS: $ */
/* $Source: /afs/.andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/overhead/index/RCS/index.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/.andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/overhead/index/RCS/index.c,v 2.3 89/02/10 23:14:23 ghoti Exp $ ";
#endif /* lint */
...
register long ahash;
{
    ...
    return fopen(tpath, (awrite? "w+" : "r"), 0666);
}
