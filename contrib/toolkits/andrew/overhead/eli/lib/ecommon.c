...
/*
 * $Header: /afs/.andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/overhead/eli/lib/RCS/ecommon.c,v 2.7 89/06/17 15:38:11 bobg Exp $ 
 *
 * $Source: /afs/.andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/overhead/eli/lib/RCS/ecommon.c,v $ 
 */
...
int *major, *minor;
{
    *major = EliProcessInfo.MajorVersion;
    *minor = EliProcessInfo.MinorVersion;
}
