\begindata{text,269215348}
\textdsversion{12}
\template{default}
\define{indent
menu:[Region~4,Indent~20]
attr:[LeftMargin LeftMargin Cm 41615]
attr:[RightMargin RightMargin Cm 41615]}
\define{footnote
...
\begindata{bp,269274080}
\enddata{bp,269274080}
\view{bpv,269274080,7,0,0}
\heading{Example
...
\begindata{bp,269273924}
\enddata{bp,269273924}
\view{bpv,269273924,8,0,0}
\center{\bold{\bigger{Appendix

}}}
The grammar recognized by the PC_Parse function 
follows\footnote{\
\begindata{fnote,269273596}
\textdsversion{12}
\define{italic
...
\enddata{fnote,269273596}
\view{fnotev,269273596,9,0,0}}.  In this grammar, lower_case strings are 
...
\enddata{zip,269370100}
\view{zipview,269370100,10,0,270}

\begindata{bp,269636648}
\enddata{bp,269636648}
\view{bpv,269636648,11,0,0}
With folding, the parse tree is abbreviated to this:


\begindata{zip,269608632}
%ViewWidth 526
%ViewHeight 180
%ObjectWidth 571
%ObjectHeight 306
...
\enddata{zip,269608632}
\view{zipview,269608632,12,573,182}
