...
\* ********************************************************************** */
/* $Header: /afs/.andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/overhead/util/hdrs/RCS/util.h,v 2.23 89/11/21 13:12:21 cfe Exp $ */
/* $ACIS: $ */
/* $Source: /afs/.andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/overhead/util/hdrs/RCS/util.h,v $ */

#ifndef _UTIL_H_
#define _UTIL_H_ 1
#if !defined(lint) && !defined(LOCORE) && defined(RCS_HDRS)
static char    *rcsid_h = "$Header: /afs/.andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/overhead/util/hdrs/RCS/util.h,v 2.23 89/11/21 13:12:21 cfe Exp $ ";
...
extern int      FindPrimaryCell();     /* int FindPrimaryCell(ppCellAuth)
                                        * struct CellAuth **ppCellAuth; Like
                                        * FindCell, except that it returns a
                                        * pointer to the primary cell, if
                                        * there is one. Return 1 if there's no
                                        * prime cell. */
...
extern int      GetCurrentUserPrimaryCell();    /* (Buf, size) */
