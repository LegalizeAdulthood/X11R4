...
\* ********************************************************************** */
/* $Header: /afs/.andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/overhead/util/lib/RCS/config.c,v 2.14 89/10/13 15:19:26 cfe Exp $ */
/* $ACIS:config.c 1.2$ */
/* $Source: /afs/.andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/overhead/util/lib/RCS/config.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/.andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/overhead/util/lib/RCS/config.c,v 2.14 89/10/13 15:19:26 cfe Exp $";
#endif /* lint */
...
int *conditionLength;
{
	...
	if (text[0] == '?')  {
	    ...
	    /* Check for Machine Type / Host Name */

	    if (text[1] == 'C' || text[1] == 'M')  {
		register char *p;
		register char *d;
