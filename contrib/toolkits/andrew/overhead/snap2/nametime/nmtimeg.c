/*
  name server that supports some names being the
  name of a pool.  The best entry from the pool will
  be returned.
  $Header: /afs/.andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/overhead/snap2/nametime/RCS/nmtimeg.c,v 2.30 89/10/13 12:10:06 cfe Exp $
  */

char *rcsid="$Header: /afs/.andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/overhead/snap2/nametime/RCS/nmtimeg.c,v 2.30 89/10/13 12:10:06 cfe Exp $";
...
FILE *dfile;
{
    ...
    fprintf(dfile,"nametimeg $Header: /afs/.andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/overhead/snap2/nametime/RCS/nmtimeg.c,v 2.30 89/10/13 12:10:06 cfe Exp $\n");
    fprintf(dfile,"nametimeg $Source: /afs/.andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/overhead/snap2/nametime/RCS/nmtimeg.c,v $\n");
