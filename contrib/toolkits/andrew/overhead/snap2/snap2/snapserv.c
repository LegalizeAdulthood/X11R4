...
\* ********************************************************************** */
/*
 *	This package contains the SNAP [Simple Network Application Protocol]
 *	Server Support Package
 *
 *	$Header: /afs/.andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/overhead/snap2/snap2/RCS/snapserv.c,v 2.6 89/04/03 11:36:03 ghoti Exp $
 */
