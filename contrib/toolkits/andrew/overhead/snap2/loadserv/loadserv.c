...
/*
  Load average server
  $Header: /afs/.andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/overhead/snap2/loadserv/RCS/loadserv.c,v 2.11 89/02/10 23:19:54 ghoti Exp $
*/

char *rcsid="$Header: /afs/.andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/overhead/snap2/loadserv/RCS/loadserv.c,v 2.11 89/02/10 23:19:54 ghoti Exp $";
...
FILE *dfile;
{
    ...
    fprintf(dfile,"loadserv $Header: /afs/.andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/overhead/snap2/loadserv/RCS/loadserv.c,v 2.11 89/02/10 23:19:54 ghoti Exp $\n");
    fprintf(dfile,"loadserv $Source: /afs/.andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/overhead/snap2/loadserv/RCS/loadserv.c,v $\n");
