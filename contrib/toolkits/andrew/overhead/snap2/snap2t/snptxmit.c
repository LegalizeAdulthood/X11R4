...
\* ********************************************************************** */
/*
 *	This package contains the SNAP [Simple Network Access Protocol]
 *	common message transmit functions
 *
 *	$Header: /afs/.andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/overhead/snap2/snap2t/RCS/snptxmit.c,v 1.6 89/02/10 23:22:55 ghoti Exp $
 */
