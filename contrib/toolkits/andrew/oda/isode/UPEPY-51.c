...
#ifndef	lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/oda/isode/RCS/UPEPY-51.c,v 1.1 89/09/21 05:20:35 mss Exp $";
#endif
...
PEPYPARM parm;
{
    if (explicit
        ...
        advise (NULLCP, "ObjectDescriptor bad class/id: %s/0x%x", 
