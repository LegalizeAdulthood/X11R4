...
#ifndef	lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/oda/isode/RCS/UPEPY-35.c,v 1.1 89/09/21 05:19:13 mss Exp $";
#endif
...
PEPYPARM parm;
{
    ...
    if (explicit
        ...
        advise (NULLCP, "GraphicString bad class/id: %s/0x%x", 
                pe_classlist[pe -> pe_class], pe -> pe_id);
        return NOTOK;
    }
    if ((p10 = prim2str (pe, &p10_len)) == NULLCP) {
        advise (NULLCP, "GraphicString bad octetstring: %s",
