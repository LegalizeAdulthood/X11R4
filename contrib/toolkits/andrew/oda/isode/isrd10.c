...
int	parse_ISRD10_Character__Coding__Attributes (pe, explicit, len, buffer, parm)
register PE	pe;
int	explicit;
int    *len;
char  **buffer;
...
#ifdef DEBUG
    (void) testdebug (pe, "ISRD10.Character-Coding-Attributes");
#endif
