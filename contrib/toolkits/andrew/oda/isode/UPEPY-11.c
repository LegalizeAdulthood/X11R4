...
#ifndef	lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/oda/isode/RCS/UPEPY-11.c,v 1.1 89/09/21 05:18:43 mss Exp $";
#endif
...
PEPYPARM parm;
{
    ...
    if (explicit
        ...
        advise (NULLCP, "PrintableString bad class/id: %s/0x%x", 
