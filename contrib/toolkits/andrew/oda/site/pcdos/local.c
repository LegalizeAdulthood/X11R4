...
/*
$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/oda/site/pcdos/RCS/local.c,v 1.5 89/11/01 10:45:01 jr Exp $
$Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/oda/site/pcdos/RCS/local.c,v $
...
$Log:	local.c,v $
 * Revision 1.5  89/11/01  10:45:01  jr
 * Fixes for buffer flushing.
 * 
 * Revision 1.3  89/11/01  09:37:50  jr
 * Have WriteChars fluch buffer.
 * 
 * Revision 1.2  89/10/31  12:40:43  jr
 * Some casting for the PC.
 * 
 * Revision 1.1  89/09/21  06:13:01  mss
 * Initial revision
 * 
...
#ifndef LINT
static char RCSID[] = "$Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/oda/site/pcdos/RCS/local.c,v $";
#endif

