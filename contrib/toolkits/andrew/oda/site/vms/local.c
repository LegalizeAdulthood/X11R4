...
/*
$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/oda/site/vms/RCS/local.c,v 1.5 89/11/01 11:00:57 jr Exp $
$Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/oda/site/vms/RCS/local.c,v $
...
$Log:	local.c,v $
 * Revision 1.5  89/11/01  11:00:57  jr
 * Buffering fixes.
 * 
 * Revision 1.4  89/11/01  09:48:17  jr
 * Flush buffer in WriteChars
 * 
 * Revision 1.3  89/10/31  12:41:53  jr
 * Some casting.
 * 
 * Revision 1.2  89/10/13  10:45:19  jr
 * This fixes a bug in creating empty output
 * files on VMS.
 * 
...
#ifndef LINT
static char RCSID[] = "$Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/oda/site/vms/RCS/local.c,v $";
#endif

