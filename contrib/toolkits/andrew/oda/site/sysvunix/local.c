...
/*
$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/oda/site/sysvunix/RCS/local.c,v 1.4 89/11/01 10:52:40 jr Exp $
$Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/oda/site/sysvunix/RCS/local.c,v $
...
$Log:	local.c,v $
 * Revision 1.4  89/11/01  10:52:40  jr
 * Buffering fixes.
 * 
 * Revision 1.3  89/11/01  09:41:59  jr
 * Have WriteChars flush buffers.
 * 
 * Revision 1.2  89/10/31  12:42:45  jr
 * Some casting.
 * 
 * Revision 1.1  89/09/21  06:09:57  mss
 * Initial revision
 * 
...
#ifndef LINT
static char RCSID[] = "$Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/oda/site/sysvunix/RCS/local.c,v $";
#endif

