...
/*
$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/oda/site/sysvunix/RCS/vlocal.c,v 1.2 89/09/29 11:50:50 mss Exp $
$Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/oda/site/sysvunix/RCS/vlocal.c,v $
...
$Log:	vlocal.c,v $
 * Revision 1.2  89/09/29  11:50:50  mss
 * Changed site.h to lcsite.h for compatibility with Andrew site files
 * 
 * Revision 1.1  89/09/21  06:10:24  mss
 * Initial revision
 * 
...
#ifndef LINT
static char RCSID[] = "$Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/oda/site/sysvunix/RCS/vlocal.c,v $";
#endif
