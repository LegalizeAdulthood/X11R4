...
/*
$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/oda/site/mac/RCS/local.c,v 1.3 89/11/01 10:45:45 jr Exp $
$Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/oda/site/mac/RCS/local.c,v $
...
$Log:	local.c,v $
 * Revision 1.3  89/11/01  10:45:45  jr
 * Fixes for buffer flushing.
 * 
 * Revision 1.2  89/10/31  12:43:43  jr
 * Some casting.
 * 
 * Revision 1.1  89/09/21  06:12:07  mss
 * Initial revision
 * 
...
#ifndef LINT
static char RCSID[] = "$Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/oda/site/mac/RCS/local.c,v $";
#endif

