...
/*
$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/oda/site/mac/RCS/vlocal.c,v 1.3 89/10/13 09:33:27 mss Exp $
$Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/oda/site/mac/RCS/vlocal.c,v $
...
$Log:	vlocal.c,v $
 * Revision 1.3  89/10/13  09:33:27  mss
 * Changed call to open to match MPW definition (no protection parameter)
 * 
 * Revision 1.2  89/09/29  11:56:31  mss
 * Changed site.h to lcsite.h for compatibility with Andrew site files
 * 
 * Revision 1.1  89/09/21  06:12:33  mss
 * Initial revision
 * 
...
#ifndef LINT
static char RCSID[] = "$Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/oda/site/mac/RCS/vlocal.c,v $";
#endif
    ...
    /*IN*/ CHAR_type	*name;
{
    ...
    rval = open(name, O_WRONLY | O_CREAT | O_TRUNC);
    if (rval >= 0) {
	goto LEAVE;
    }
