...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/eq/RCS/draweqv.c,v 2.7 89/04/20 13:44:25 pgc Exp $ */
/* $ACIS:draweqv.c 1.4$ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/eq/RCS/draweqv.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/eq/RCS/draweqv.c,v 2.7 89/04/20 13:44:25 pgc Exp $";
#endif /* lint */
...
enum space spacing[(int)MAX_genre][(int)MAX_genre] = {
    ...
    /* OP */	THIN,	THIN,	BAD,	CTHICK,	NOSPC,	NOSPC,	NOSPC,	CTHIN,
    /* BIN */	CMED,	CMED,	BAD,	BAD,	CMED,	BAD,	BAD,	CMED,
    /* REL */	CTHICK,	CTHICK,	BAD,	NOSPC,	CTHICK,	NOSPC,	NOSPC,	CTHICK,
    /* OPEN */	NOSPC,	NOSPC,	BAD,	NOSPC,	NOSPC,	NOSPC,	NOSPC,	NOSPC,
    /* CLOSE */	NOSPC,	THIN,	CMED,	CTHICK,	NOSPC,	NOSPC,	NOSPC,	CTHIN,
    /* PUNCT */	CTHIN,	CTHIN,	BAD,	CTHICK,	CTHIN,	CTHIN,	CTHIN,	CTHIN,
