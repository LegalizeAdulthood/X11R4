...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/console/cmd/RCS/mailmon.c,v 2.17 89/10/18 13:34:00 cfe Exp $ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/console/cmd/RCS/mailmon.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/console/cmd/RCS/mailmon.c,v 2.17 89/10/18 13:34:00 cfe Exp $";
#endif /* lint */
...
struct consoleClass *self;
{
    ...
    SetMailEnv();
    if (UseNonAndrewMail) {
        if (strlen(envmail) < (strlen(_SITE_NON_ANDREW_MAIL) + 1)) {
            envmail = NULL;
...
SetPrintEnv()
{
	...
	if (!buff || !*buff) {
		...
		printer_name = environ_GetProfile("print.spooldir");
...
#ifndef hpux /*  temporary hack, 2 expr were not opened */
	}
    }
#endif /* hpux */
