...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/console/lib/RCS/conclass.c,v 2.8 89/10/29 13:35:40 ghoti Exp $ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/console/lib/RCS/conclass.c,v $ */

#ifndef lint
char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/console/lib/RCS/conclass.c,v 2.8 89/10/29 13:35:40 ghoti Exp $";
#endif /* lint */
...
struct consoleClass *consoleClass__Hit(self, action, x, y, numberOfClicks)
struct consoleClass *self;
...
long numberOfClicks;
{
	...
	scroll_Hit(mydisp->ScrollLogView, action, newx, newy, numberOfClicks);
    }
    else{
