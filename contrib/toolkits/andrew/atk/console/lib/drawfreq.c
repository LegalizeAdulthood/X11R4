...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/console/lib/RCS/drawfreq.c,v 2.12 89/06/15 13:10:26 mmackay Exp $ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/console/lib/RCS/drawfreq.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/console/lib/RCS/drawfreq.c,v 2.12 89/06/15 13:10:26 mmackay Exp $";
#endif /* lint */
...
struct RegionLog *rlogptr;
{
    ...
    s = (char *)malloc(strlen(string) + strlen(timestring) + 1);
    if (s == NULL) {
