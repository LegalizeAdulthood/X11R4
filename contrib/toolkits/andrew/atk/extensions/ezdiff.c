...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/extensions/RCS/ezdiff.c,v 2.10 89/10/27 15:07:35 tpn Exp $ */
/* $ACIS:ezdiff.c 1.4$ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/extensions/RCS/ezdiff.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/extensions/RCS/ezdiff.c,v 2.10 89/10/27 15:07:35 tpn Exp $";
#endif /* lint */
#include <class.h>
...
struct ezdiff *firstlink , *lastlink;
...
static ezdiff_setupmarkers(self,s)
struct ezdiff *self;
char *s;
{
    struct text *d1,*d2;
