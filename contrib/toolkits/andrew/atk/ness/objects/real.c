...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/ness/objects/RCS/real.c,v 1.11 89/10/25 22:32:57 zs01 Exp $ */
/* $ACIS:$ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/ness/objects/RCS/real.c,v $ */

#if !defined(lint) && !defined(LOCORE) && defined(RCS_HDRS)
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/ness/objects/RCS/real.c,v 1.11 89/10/25 22:32:57 zs01 Exp $";
#endif

#include <andrewos.h>	/* for xyz_ENV */
	...
	unsigned char *iar;
{
	...
	case  'e':
		...
		NSP = (union stackelement *)(((unsigned long)NSP) 
				+ (sizeof(struct dblstkelt)-sizeof (struct longstkelt)));
		NSP->l.hdr = longHdr;
		break;
	case  'f':
	case  'g':
		...
		x = NSP->d.v;
		NSP = (union stackelement *)(((unsigned long)NSP) 
				+ (sizeof(struct dblstkelt)-sizeof (struct boolstkelt)));
		NSP->b.hdr = boolHdr;
		break;
	case 'j':
		/* integer to real */
		...
		l = NSP->l.v;
		NSP = (union stackelement *)(((unsigned long)NSP) 
				+ (sizeof(struct longstkelt)-sizeof (struct dblstkelt)));
		NSP->d.hdr = dblHdr;
		break;
	case 'k':		/* jn(n, x) */
	case 'l':		/* yn(n, x) */
