...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/text/RCS/fnote.c,v 1.5 89/08/20 00:41:22 zs01 Exp $ */
/* $ACIS:fnote.c 1.3$ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/text/RCS/fnote.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/text/RCS/fnote.c,v 1.5 89/08/20 00:41:22 zs01 Exp $";
#endif /* lint */
...
/*    if((fnote_GetLength(self)) ==  0) return FALSE; */
...
static boolean close(self,text)
struct fnote *self;
struct text *text;
{   /* This routine should only be called after doupdate has properly updated the env pointers*/
    long len;
...
/*    if(environment_GetLength(self->env) ==  1) return FALSE; */
    len = (self->loc + environment_GetLength(self->env) - 1 ) - self->ownloc;
