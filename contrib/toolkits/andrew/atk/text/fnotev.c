...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/text/RCS/fnotev.c,v 1.6 89/07/24 11:20:37 tpn Exp $ */
/* $ACIS:$ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/text/RCS/fnotev.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/text/RCS/fnotev.c,v 1.6 89/07/24 11:20:37 tpn Exp $";
#endif /* lint */
...
*/
	...
	if(ln > 0) fputc('\n',f);
	    ...
	    clevel = toplevel;
	    texttroff_WriteTroff( self, d, f, toplevel);
	}
	fprintf(f,".FE\n");
	clevel = -100;
    }
