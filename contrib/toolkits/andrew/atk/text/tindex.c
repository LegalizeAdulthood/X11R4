...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/text/RCS/tindex.c,v 1.5 89/10/05 11:23:20 cfe Exp $ */
/* $ACIS:$ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/text/RCS/tindex.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/text/RCS/tindex.c,v 1.5 89/10/05 11:23:20 cfe Exp $";
#endif /* lint */
#include <andrewos.h>
#include <environ.ih>
#include <print.ih>
...
struct view *self;
{
    ...
    if(buf)
	return buffer_EnumerateViews(buf,FindView,NULL);
    return NULL;
}
...
struct view *self;
{
    tindex_PrintIndex(getrealview(self));
}
static void previewindex(self)
struct view *self;
{
    tindex_PreviewIndex(getrealview(self));
}
...
struct classheader *ClassID; 
{
    ...
    proctable_DefineProc("tindex-print",printindex,viewtype,NULL,"print index");
    proctable_DefineProc("tindex-preview",previewindex,viewtype,NULL,"preview index");
    proctable_DefineProc("tindex-index-term",tindex_IndexTermCmd,viewtype,NULL,"index all instances of a term");
    proctable_DefineProc("tindex-read-index-file",tindex_ReadIndexFile,viewtype,NULL,"read a list of index terms ");
    proctable_DefineProc("tindex-write-index-file",tindex_WriteIndexFile,viewtype,NULL,"write a list of index terms ");
    proctable_DefineProc("tindex-index-italic",tindex_MakeIndexItalic,viewtype,NULL,"make the index entries italic");
    proctable_DefineProc("tindex-index-plain",tindex_MakeIndexPlain,viewtype,NULL,"make the index entries plain");
    proctable_DefineProc("tindex-expose-inv-index",tindex_ExposeInvIndex,viewtype,NULL,"Expose the invisible index entries");
    proctable_DefineProc("tindex-hide-inv-index",tindex_HideInvIndex,viewtype,NULL,"Hide the invisible index entries");
