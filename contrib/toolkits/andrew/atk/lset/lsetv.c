...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/lset/RCS/lsetv.c,v 2.7 89/08/01 10:39:40 tpn Exp $ */
/* $ACIS: $ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/lset/RCS/lsetv.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/lset/RCS/lsetv.c,v 2.7 89/08/01 10:39:40 tpn Exp $ ";
#endif /* lint */
...
#define Islinked(self) (((struct view *)self)->parent != NULL)
...
struct lset *ls;
{
    ...
    if(*ls->viewname != '\0' /* && ls->dobj != NULL */ && (self->child = (struct view *) class_NewObject(ls->viewname)))  {
...
/*    menulist_AddToML(newMenus,"lset,Set Object~31",tempProc,NULL,0); */
    tempProc = proctable_DefineProc(cmdString = "lsetview-Destroy-Object", lsetview_DestroyView,&lsetview_classinfo,NULL, "Destroy the child view");
    keymap_BindToKey(newKeymap,cmdString,tempProc,"\033d");
