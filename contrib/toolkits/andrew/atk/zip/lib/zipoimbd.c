...
static char	rcsid[] = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/zip/lib/RCS/zipoimbd.c,v 2.12 89/09/08 17:42:00 ghoti Exp $";

/*
    $Log:	zipoimbd.c,v $
 * Revision 2.12  89/09/08  17:42:00  ghoti
