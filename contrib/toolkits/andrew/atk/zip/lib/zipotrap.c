...
static char	rcsid[] = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/zip/lib/RCS/zipotrap.c,v 2.8 89/09/08 17:42:48 ghoti Exp $";

/*
    $Log:	zipotrap.c,v $
 * Revision 2.8  89/09/08  17:42:48  ghoti
