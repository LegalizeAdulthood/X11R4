...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/zip/lib/RCS/zip.c,v 2.8 89/08/23 16:33:36 tom Exp $ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/zip/lib/RCS/zip.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/zip/lib/RCS/zip.c,v 2.8 89/08/23 16:33:36 tom Exp $";
#endif /* lint */
...
zip__InitializeObject( classID, self )
  ...
  long				      Init_Message_Writer(),
				      Init_Message_Clearer(),
				      Init_Message_Acknowledger();
