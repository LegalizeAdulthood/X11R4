...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/zip/lib/RCS/zipve01.c,v 2.9 89/09/28 11:07:09 sg08 Exp $ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/zip/lib/RCS/zipve01.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/zip/lib/RCS/zipve01.c,v 2.9 89/09/28 11:07:09 sg08 Exp $";
#endif /* lint */
...
static short			ZIP_pane_coordinate_font; /*===*/
...
/*===  zipedit_Compute_Pane_Stretch_Factors( self, pane );===*/
  if ( ZIP_pane_coordinate_font == NULL )
    zip_Define_Font( Data, ZIP_pane_coordinate_font_name, &ZIP_pane_coordinate_font );
...
Draw_Pane_Coordinate_Ticks( self, pane )
  ...
  zipview_SetFont( View, Fonts->zip_fonts_vector[ZIP_pane_coordinate_font].zip_fonts_table_font );
