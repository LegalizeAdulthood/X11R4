...
static char	rcsid[] = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/zip/lib/RCS/zipofcap.c,v 2.6 89/09/11 08:17:28 ghoti Exp $";

/*
    $Log:	zipofcap.c,v $
 * Revision 2.6  89/09/11  08:17:28  ghoti
