...
static char	rcsid[] = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/zip/lib/RCS/zipoplin.c,v 2.7 89/09/11 08:17:34 ghoti Exp $";

/*
    $Log:	zipoplin.c,v $
 * Revision 2.7  89/09/11  08:17:34  ghoti
