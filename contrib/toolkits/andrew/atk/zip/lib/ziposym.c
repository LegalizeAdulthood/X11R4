...
static char	rcsid[] = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/zip/lib/RCS/ziposym.c,v 2.19 89/11/20 12:51:16 gk5g Exp $";
...
struct symbol				 *Symbol_Set_Vector();
struct symbol_set			 *Symbol_Set();
char					 *Symbol_Algorithm(), *Pixel(), *Number(),
					 *String(), *Skip_Colon();
enum view_MouseAction			  Accept_Property_Hit();
long					  Show_Symbol_Dialog();

boolean
