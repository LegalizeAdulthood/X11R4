...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/zip/lib/RCS/zipve02.c,v 2.12 89/09/11 08:17:55 ghoti Exp $ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/zip/lib/RCS/zipve02.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/zip/lib/RCS/zipve02.c,v 2.12 89/09/11 08:17:55 ghoti Exp $";
#endif /* lint */
...
zipedit_Handle_Font_Height_Selection( self, pane, action, x, y, clicks )
  ...
  if ( action == view_LeftDown  ||  action == view_RightDown )
	...
	FontHeight = 2;
      zip_Set_Figure_Text( Data, figure, sprintf( msg, "%2d", FontHeight ) );
      }
    else
