...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/zip/lib/RCS/zipds01.c,v 2.6 89/02/23 14:50:32 ghoti Exp $ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/zip/lib/RCS/zipds01.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/zip/lib/RCS/zipds01.c,v 2.6 89/02/23 14:50:32 ghoti Exp $";
#endif /* lint */
...
zip__Parse_Figure_Attributes( self, figure )
  ...
  register zip_type_figure	      figure;
  {
  register int			      end_of_attributes;
  register long			      status = zip_ok;
...
===*/
	...
	c = NextChar();
	if ( c == 'W' )
	  figure->zip_figure_line_width = Parse_Stream_Integer();
	else if ( c == 'S' )
	  figure->zip_figure_line_style = Parse_Stream_Integer();
        break;
      default:
...
/*===*/
	...
	c = NextChar();
	if ( c == 'W' )
	  image->zip_image_line_width = Parse_Stream_Integer();
/*===	else if ( c == 'S' )
	  image->zip_image_line_style = Parse_Stream_Integer(); ===*/
        break;
      default:
	DEBUG(Attribute Default);
	if ( ! Parse_Stream_Commentary( self, c ) )
