...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/basics/wm/RCS/wim.c,v 1.17 89/10/04 18:48:53 cfe Exp $ */
/* $ACIS:im.c 1.5$ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/basics/wm/RCS/wim.c,v $ */

#ifndef lint
char *wm_rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/basics/wm/RCS/wim.c,v 1.17 89/10/04 18:48:53 cfe Exp $";
#endif /* lint */
...
*/
#define wmim_SelectWMCursor(CURSOR,self) 		(((struct cursor *)(CURSOR))->fillFont == NULL) ? wm_SetStandardCursor(((struct cursor *)(CURSOR))->fillChar) :  wm_SetCursor(fontdesc_GetRealFontDesc(((struct cursor *)(CURSOR))->fillFont, (struct view *)self),((struct cursor *)(CURSOR))->fillChar)
