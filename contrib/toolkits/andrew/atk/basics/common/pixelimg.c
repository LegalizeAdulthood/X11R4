...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/basics/common/RCS/pixelimg.c,v 2.9 89/08/03 12:05:20 ghoti Exp $ */
/* $ACIS:pixelimg.c 1.7$ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/basics/common/RCS/pixelimg.c,v $ */

#ifndef lint
	char *pixelimage_rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/basics/common/RCS/pixelimg.c,v 2.9 89/08/03 12:05:20 ghoti Exp $";
#endif /* lint */
...
*/
	...
	GetRow(source, subx, suby, width, (unsigned char *)bitbuf);
	SetRow(self, x, y + locy, width, (unsigned char *)bitbuf); }
