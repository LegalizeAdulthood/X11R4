...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/basics/common/RCS/rect.c,v 2.5 89/02/17 18:40:04 ghoti Exp $ */
/* $ACIS:rect.c 1.5$ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/basics/common/RCS/rect.c,v $ */

#ifndef lint
	char *rectangle_rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/basics/common/RCS/rect.c,v 2.5 89/02/17 18:40:04 ghoti Exp $";
#endif /* lint */

/*
 * $Log:	rect.c,v $
 * Revision 2.5  89/02/17  18:40:04  ghoti
