/***********************************************************
  ...
  documentation for any purpose and without fee is hereby granted, 
      ...
      SOFTWARE.
      ******************************************************************/
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/raster/cmd/RCS/dispbox.c,v 2.5 89/02/17 16:57:28 ghoti Exp $ */
/* $ACIS:rasterv.c 1.3$ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/raster/cmd/RCS/dispbox.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/raster/cmd/RCS/dispbox.c,v 2.5 89/02/17 16:57:28 ghoti Exp $";
#endif /* lint */
...
boolean gray;
{
	...
	if (! gray) {
		...
		if (w==1) w = 2; else h = 2;
		graphic_FillRectSize(G, x, y, w, h, self->GreyPattern); }
...
struct rasterimage *pix;
{
	...
	if (w==1) w = 2; else h = 2;
	graphic_FillRectSize(G, x, y, ++w, ++h, self->WhitePattern);
	rasterview_SetTransferMode(self, graphic_COPY);
	if (x <= -Xoff) x = -Xoff;
	if (y <= -Yoff) y = -Yoff;
...
boolean bit;
{
    ...
    graphic_FillRect(G, &sub, pattern);
