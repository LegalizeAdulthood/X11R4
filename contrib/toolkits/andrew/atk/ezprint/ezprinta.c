...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/ezprint/RCS/ezprinta.c,v 2.17 89/10/20 14:42:52 tpn Exp $ */
/* $ACIS:ezprinta.c 1.2$ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/ezprint/RCS/ezprinta.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/ezprint/RCS/ezprinta.c,v 2.17 89/10/20 14:42:52 tpn Exp $";
#endif /* lint */
...
struct ezprintapp *self;
{
    ...
    fprintf(stderr,"usage: %s <-S PrinterName> <-troff> <-preview> <-stdin> < -o OutputFileName> <-v ScribeVersion> <-contents> <-zapafterprinting> <-Enumerate> <-IndexOnly> <-quiet> file\n",progname);
    exit(2);
}
