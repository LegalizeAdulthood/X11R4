...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/table/RCS/spread.c,v 1.4 89/02/17 17:27:04 ghoti Exp $ */
/* $ACIS:spread.c 1.6$ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/table/RCS/spread.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/table/RCS/spread.c,v 1.4 89/02/17 17:27:04 ghoti Exp $";
#endif /* lint */
...
long status;
{
    ...
    if (changed == (struct observable *) MyTable(V))  {
