...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/table/RCS/menu.c,v 1.6 89/10/17 17:24:50 cfe Exp $ */
/* $ACIS:menu.c 1.3$ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/table/RCS/menu.c,v $ */

#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/table/RCS/menu.c,v 1.6 89/10/17 17:24:50 cfe Exp $";
#endif /* lint */
...
char ch;
{
	...
	table_Destroy(table_ExtractData(MyTable(V), &(V->selection)));
