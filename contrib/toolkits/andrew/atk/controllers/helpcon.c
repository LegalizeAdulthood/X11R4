...
\* ********************************************************************** */
/* $Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/controllers/RCS/helpcon.c,v 2.5 89/02/17 15:18:38 ghoti Exp $ */
/* $ACIS: $ */
/* $Source: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/controllers/RCS/helpcon.c,v $ */
#ifndef lint
static char *rcsid = "$Header: /afs/andrew.cmu.edu/itc/sm/releases/X.V11R4/andrew/atk/controllers/RCS/helpcon.c,v 2.5 89/02/17 15:18:38 ghoti Exp $ ";
#endif /* lint */
...
GetHelpOn(self,buf,type,SaveHistory)
struct helpcon *self;
char *buf,*type;
{   /* look up the file in the help directory and insert in the body text */
    char bb[512],*objectName,*cp,*index();
    FILE *f;
    int objectID;
...
void handleclicks(self,cv,position, numberOfClicks, action, startLeft, startRight, leftPos, rightPos,which,type)
struct helpcon *self;
