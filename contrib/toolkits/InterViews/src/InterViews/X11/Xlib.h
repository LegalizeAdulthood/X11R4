...
void XGrabButton(
    Display*, Mask, Mask, Window, Bool,
    Mask, int ptrmode, int kbdmode, Window confined, XCursor
);
void XUngrabButton(Display*, Mask, Mask, Window);
int XGrabPointer(
    Display*, Window, Bool, Mask, int ptrmode, int kbdmode,
    Window confined, XCursor, Time
);
void XUngrabPointer(Display*, Time);
void XChangeActivePointerGrab(Display*, Mask, XCursor, Time);
void XGrabKeyboard(Display*, Window, Bool, int ptrmode, int kbdmode, Time);
void XUngrabKeyboard(Display*, Time);
void XGrabKey(Display*, int, Mask, Window, Bool, int ptrmode, int kbdmode);
void XUngrabKey(Display*, int key, Mask, Window);
...
void XWindowEvent(Display*, Window, Mask, XEvent*);
int XCheckWindowEvent(Display*, Window, Mask, XEvent*);
void XMaskEvent(Display*, Mask, XEvent*);
int XCheckMaskEvent(Display*, Mask, XEvent*);
XTimeCoord* XGetMotionEvents(
    Display*, Window, Time start, Time stop, int* nevents
);

void XSendEvent(Display*, Window, Bool, Mask, XEvent*);
