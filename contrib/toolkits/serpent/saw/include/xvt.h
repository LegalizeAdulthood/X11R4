	/* $Header: /u/04c/mnt/integ/sxt/include/RCS/xvt.h,v 1.3 89/02/17 03:25:50 ejh Exp $ */
...
|  Change History:
$Log:	xvt.h,v $
 * Revision 1.3  89/02/17  03:25:50  ejh
 * fixed x includes
 * 
 * Revision 1.2  89/02/09  20:34:51  ejh
 * added copyright notice
 * 
 * Revision 1.1  88/11/14  17:05:11  ejh
 * Initial revision
 * 
...
|	match a vertical pane widget part component name, which is a string,
...
|
|  Description:
|	xvt_process_changes processes vertical pane widget records from the
|	dialogue manager.
|
|  Syntax:
\*                                                                          */
	void	xvt_process_changes (
