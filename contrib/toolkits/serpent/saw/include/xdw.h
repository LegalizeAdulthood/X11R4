	/* $Header: /u/04c/mnt/integ/sxt/include/RCS/xdw.h,v 1.3 89/02/17 03:22:16 ejh Exp $ */
...
|  Change History:
$Log:	xdw.h,v $
 * Revision 1.3  89/02/17  03:22:16  ejh
 * fixed x includes
 * 
 * Revision 1.2  89/02/09  20:25:28  ejh
 * added copyright notice
 * 
 * Revision 1.1  88/11/14  16:54:54  ejh
 * Initial revision
 * 
...
|	match a dialog widget part component name, which is a string, with the
...
|
|  Description:
|	xdw_process_changes processes dialog_widget records from the dialogue
|	manager.
|
|  Syntax:
\*                                                                          */
	void xdw_process_changes (
