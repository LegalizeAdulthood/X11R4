 ...
 * 
 * $Header: xgks.h,v 4.0 89/08/31 16:36:02 amy Exp $
 *
 * $Source: /andrew/Xgks/source/xgks.bld/include/RCS/xgks.h,v $
 *
 * $Log:	xgks.h,v $
 * Revision 4.0  89/08/31  16:36:02  amy
 * Changed IBM copyright for MIT distribution.
 * 
 * Revision 3.14  89/06/05  10:31:25  bruce
 * PTR# c1179:	Changed character expansion variable names for AIX.
 * 
 * Revision 3.13  88/12/09  17:12:13  amy
 * Changed errginqindividualattr to errginqindivattr.
 * 
 * Revision 3.12  88/12/09  13:52:48  amy
 * Added #define to equate GCOLOR to GCOLOUR.
 * 
 * Revision 3.11  88/12/09  12:09:21  amy
 * Added #define to equate gescsetcolormask to gescsetcolourmask.
 * 
 * Revision 3.10  88/12/08  18:05:49  amy
 * Changed errginqpickid to errginqcurpickid.
 * 
 * Revision 3.9  88/12/08  16:57:48  amy
 * PTR c1130	Updated typedef with correct enumerated type value.
 * 
 * Revision 3.8  88/12/07  15:16:11  amy
 * Changed spellings from American to British:  color to colour, meter to metre,
 * and center to centre.
 * 
 * Revision 3.7  88/12/06  16:07:42  amy
 * PTR c1130	Added more values to typedef of function names used by
 * 		error-handling functions.
 * 
 * Revision 3.6  88/12/05  14:35:56  amy
 * PTR c1130	Added typedefs for function names used by error-handling
 * 		functions.
 * 
 * Revision 3.5  88/08/19  13:59:33  amy
 * Removed duplicate definition of Gipoint.
 * 
 * Revision 3.4  88/08/19  13:54:30  amy
 * AUG  Gdspsize:  raster changed from Gpoint to Gipoint.
 *      Glnfac:  "width" field changed to "widths."
 *      Gmkfac:  "size" field changed to "sizes."
 * 
 * Revision 1.1  88/07/21  10:47:34  david
 * Initial revision
 *  
 *
 */
