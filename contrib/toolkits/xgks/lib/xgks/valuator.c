 ...
 */
Gint ginitval(Gint ws_id, Gint dev, Gfloat init, Gint pet, Glimit *area, Gvalrec *record)
{
    WS_STATE_PTR ws;
    INPUT_DEV *idev;
    XGCValues gcvalues;
 ...
 */
Gint gsetvalmode(Gint ws_id, Gint dev, Gimode mode, Gesw echo)
{
    WS_STATE_PTR ws;
    INPUT_DEV *idev;
    XGCValues gcvalues;
 ...
 */
Gint greqval(Gint ws_id, Gint dev, Gqval *response)
{
    WS_STATE_PTR ws;
    INPUT_DEV *idev;
    XGCValues gcvalues;
 ...
 */
Gint gsampleval(Gint ws_id, Gint dev, Gfloat *response)
{
    WS_STATE_PTR ws;
    INPUT_DEV *idev;
