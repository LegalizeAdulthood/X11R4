...
static                _XtTextScroll() ;
static XwEditResult   ReplaceText () ;
static void           DisplayText() ;
static                ClearWindow () ;
static                ClearText () ;     
static                DisplayAllText () ;
static                CheckResizeOrOverflow() ;
static void           ProcessExposeRegion() ;
static int            _XtTextPrepareToUpdate() ;
static                FlushUpdate() ;
static                _XtTextShowPosition() ;
static                _XtTextExecuteUpdate() ;
...
*/
/*--------------------------------------------------------------------------+*/
static _XtTextNeedsUpdating(ctx, left, right)
/*--------------------------------------------------------------------------+*/
  XwTextEditWidget ctx;
...
/*--------------------------------------------------------------------------+*/
  ...
  XwTextPosition position;
{
    XwTextPosition line, lines, lastLine ;
    Boolean     rebuild;
    int		i;
...
/*--------------------------------------------------------------------------+*/
     ...
     int		updateMode ;
{
  XwLineTableEntryPtr lp, currLine ;
  XwLineTablePtr      lt ;
...
/*--------------------------------------------------------------------------+*/
static ClearText (ctx)
/*--------------------------------------------------------------------------+*/
  XwTextEditWidget ctx;
{
  register XwTextEditPart *text = (XwTextEditPart *) &(ctx->text);
  (*(text->sink->clearToBackground))
             (ctx, text->leftmargin, text->topmargin,
...
*/
/*--------------------------------------------------------------------------+*/
static DisplayAllText (w)
/*--------------------------------------------------------------------------+*/
  Widget w;
{
    XwTextEditWidget ctx = (XwTextEditWidget) w;

    if (!XtIsRealized(ctx)) return;
...
/*--------------------------------------------------------------------------+*/
  XwTextEditWidget ctx;
{
  XwTextPosition posToCheck;
  XwTextLineRange i, line, nLines ;
  Dimension width;
...
*/
/*--------------------------------------------------------------------------+*/
static int _XtTextPrepareToUpdate(ctx)
/*--------------------------------------------------------------------------+*/
  XwTextEditWidget ctx;
{
...
*/
/*--------------------------------------------------------------------------+*/
static _XtTextShowPosition(ctx)
/*--------------------------------------------------------------------------+*/
  XwTextEditWidget ctx;
{
...
*/
/*--------------------------------------------------------------------------+*/
static _XtTextExecuteUpdate(ctx)
/*--------------------------------------------------------------------------+*/
  XwTextEditWidget ctx;
{
    if ((ctx->text.oldinsert >= 0) && ctx->text.update_flag) {
