...
\date{Version 7.1\\
November, 1989 \\[2 in]
\copyright 1987, 1988, 1989\  Texas Instruments Incorporated\\[.5in]
\parbox{3.5in}{
...
{\samepage
\SAMEL{Focus Management}{ch:focus-management}
\index{input, focus}
...
normal hints property}\index{property, normal hints} 
\end{quote}
}\end{flushright}
...
property}\index{property, protocols} 
\end{quote}
...
property}\index{property, colormap windows} 
\end{quote}
...
{\tt :wm\_hints} property of a {\tt top-level-shell}.\index{top-level-shell, hints
property}\index{property, hints} 
\end{quote}
...
property}\index{property, icon name} 
\end{quote}
...
property}\index{property, client machine} 
\end{quote}
}\end{flushright}
...
property}\index{property, command} 
\end{quote}
}\end{flushright}
