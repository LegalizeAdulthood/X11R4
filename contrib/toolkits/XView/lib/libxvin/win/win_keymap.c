#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)win_keymap.c 20.13 89/08/18";
#endif
#endif
...
/* ismeta() is an addition to the <ctype.h> stuff for meta-characters */
#define ismeta(c)	(META_FIRST <= (c) && (c) <= META_LAST)
