#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)othr_strms.c 20.13 89/11/21";
#endif
#endif
    ...
    STREAM         *in;
{
    ...
    if (value == NULL) {
	xv_error((Xv_object)in, XV_ERROR_RECOVERABLE, XV_ERROR_SYSTEM, NULL);
	return ((STREAM *)NULL);
    }
    ...
    data = (struct xv_filter_comments_stream_data *) malloc(
