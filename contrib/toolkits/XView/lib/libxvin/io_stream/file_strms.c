#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)file_strms.c 20.12 89/11/21";
#endif
#endif
    ...
    Bool            append;
{
    ...
    data = (struct xv_file_output_stream_data *) malloc(
