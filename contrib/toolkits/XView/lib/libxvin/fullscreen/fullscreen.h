...
#define FULLSCREEN_ALLOW_ASYNC_EVENTS \
				  FULLSCREEN_SYNC, FALSE	      /* --S */
/*
 * **********************************************************************
 * 
 * 
...
extern          fullscreen_set_cursor();
extern          fullscreen_set_inputmask();
extern          fullscreen_destroy();
