#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)pf_text.c 20.19 89/10/10 SMI";
#endif
#endif
    ...
    char           *str;
{
     ...
     */
    (void) xv_get(pf, FONT_STRING_DIMS, str, &string_dims);
    ...
    XSetFont(xv_default_display, glyph_gc, xv_get(pf, XV_XID));
    ...
    register char  *str;
{
    ...
    XFontStruct    *font_info = (XFontStruct *) xv_get(pf,
						       FONT_INFO);
