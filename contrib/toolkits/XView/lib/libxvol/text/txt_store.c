#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)txt_store.c 1.16 89/10/24";
#endif
#endif
    ...
    Event          *ie;
{
    ...
    dir_str = (char *) panel_get_value(store_panel_items[(int) DIR_STRING_ITEM]);
    file_str = (char *) panel_get_value(
				      store_panel_items[(int) FILE_STRING_ITEM]);
