#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)txt_line.c 1.17 89/10/24";
#endif
#endif
    ...
    Event          *ie;
{
    ...
    line_number = (char *) panel_get_value(
    ...
    Textsw_view_handle view;
{
    ...
    static char    *sel_line = "Select Line at Number";
	...
	panel_create_item(panel, PANEL_TEXT,
			  ...
			  PANEL_LABEL_STRING, "Line Number:",
