#ifndef lint
#ifdef sccs
static char     sccsid[] = "@(#)txt_search.c 20.32 89/11/02";
#endif
#endif
...

{
    ...
    strncpy(buf, (char *) panel_get(
				    search_panel_items[(int) FIND_STRING_ITEM], PANEL_VALUE), MAX_STR_LENGTH);
    ...
    Menu_item       item;
{
    ...
    int             wrapping_off = (int) panel_get(search_panel_items[(int) WRAP_ITEM], PANEL_VALUE);
