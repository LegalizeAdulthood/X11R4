...
char	*argv[];
{
    Canvas	canvas;
    Menu	menu;
    void	my_notify_proc(), my_event_proc(), menu_done();
    extern void	exit();
...
/*
 * menu_done - menu has been popped-down.  Make sure the command frame panel
 * matches the menu.
 */
void
...
Xv_opaque result;
{
    ...
    /* set that paenl item to be the default item */
