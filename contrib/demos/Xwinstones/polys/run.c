...
extern XPoint xpt[];
extern int poly_shape;
extern int poly_verts;
...
optionsPtr ops;
{
	...
	{
		XFillPolygon(ops->display,ops->window,ops->fggc,xpt,poly_verts,poly_shape,CoordModeOrigin);
	}

	return(ops->count * poly_verts);
}
