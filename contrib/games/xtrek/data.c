...
/* Space */
int DETDIST = 1500;    /* At this range a player can detonate a torp */
int ORBDIST = 900;     /* At this range a player can orbit a planet */
int PFIREDIST = 1500;  /* At this range a planet will shoot at a player */
int PHITANG = 5;       /* Number of degrees that a phaser will hit*/
int PHITANGL = 10;     /* Number of degrees that a locked phaser will hit*/
...
struct empirestats empstats[MAXEMPIRES];
