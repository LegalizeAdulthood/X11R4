...
#define WARP1 (16 / UPS) 		/* warp 1 moves 160 spaces per sec */
...
#define VICTORY 16	/* Number of planets needed to conquer the galaxy */
#define MINARMIES 10	/* Can't bomb a planet when armies <= this */
...
extern int setimer(), accept();
extern void perror(), close();
