  ...
  register struct player *p;
{
  ...
  case KWinner:
    ...
    if (p->p_no != p->p_whodead)
      /* Allow them to repick any empire.  However, the winner can't be allowed to repick any empire as we have to keep his empire affiliation around in order to print his designation in other players' death messages. */
      p->p_mask = ALLEMPIRE;
    warning (p, buf);
    break;
  default:
