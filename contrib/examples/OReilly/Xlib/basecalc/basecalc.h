...
{"\-s",		UNSIGNED,		XrmoptionNoArg,		(caddr_t) "off"},
{"\-x",		BASE,		XrmoptionNoArg,		(caddr_t) "16"},
{"\-h",		BASE,		XrmoptionNoArg,		(caddr_t) "16"},
{"\-d",		BASE,	 	XrmoptionNoArg,		(caddr_t) "10"},
{"\-o",		BASE,	 	XrmoptionNoArg,		(caddr_t) "8"},
{"\-b",		BASE,	 	XrmoptionNoArg,		(caddr_t) "2"},
