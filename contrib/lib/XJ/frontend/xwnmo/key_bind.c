...
{ "redraw_line" ,"" ,1,  reset_line , reset_line , reset_line, NULL, redraw_select, reset_line, reset_line, NULL, NULL, NULL, NULL},
{ "redraw_line_e" ,"" ,1,  reset_line , reset_line , reset_line , reset_line , redraw_select , reset_line, reset_line, NULL, NULL, NULL, NULL},
...
{ "touroku_mark_set" ,"" ,0,  NULL , NULL , NULL , NULL , NULL , NULL,NULL, NULL, NULL, NULL, NULL},
{ "touroku_return" ,"" ,0,  NULL , NULL , NULL , NULL , NULL , NULL, t_ret, NULL, NULL, NULL, NULL},
{ "quit" ,"" ,0,  NULL , NULL , NULL , NULL , quit_select , t_quit, t_quit, NULL, NULL, NULL, quit_select},
...
{ "lineend_select", "",0,  NULL, NULL, NULL, NULL, lineend_select, NULL, NULL,NULL, NULL, NULL, NULL},
{ "linestart_select", "",0,  NULL, NULL, NULL, NULL, linestart_select, NULL, NULL, NULL, NULL, NULL, NULL},
/*{ "previous_select", "",0,  NULL, NULL, NULL, NULL, previous_select, NULL, NULL, NULL, NULL, NULL, previous_inspect}, */
{ "previous_select", "",0,  NULL, NULL, NULL, NULL, previous_select, NULL, NULL, NULL, NULL, NULL, xw_back_inspect},
/*{ "next_select", "",0,  NULL, NULL, NULL, NULL, next_select, NULL, NULL, NULL, NULL, NULL, next_inspect}, */
{ "next_select", "",0,  NULL, NULL, NULL, NULL, next_select, NULL, NULL, NULL, NULL, NULL, xw_next_inspect},
{ "backward_select", "",0,  NULL, NULL, NULL, NULL, backward_select, NULL, NULL, NULL, NULL, NULL, NULL},
{ "forward_select", "",0,  NULL, NULL, NULL, NULL, forward_select, NULL, NULL, NULL, NULL, NULL, NULL},
...
{ "del_entry","",0, NULL , NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, inspectdel},
/*{ "use_entry","",0,  NULL , NULL, NULL, NULL, NULL, NULL, NULL, NULL, kworduse, kdicuse, inspectuse},*/
{ "use_entry","",0,  NULL , NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, inspectuse},
/*{ "com_entry","",0,  NULL , NULL, NULL, NULL, NULL, NULL, NULL, NULL, kwordcom, kdiccom, NULL},*/
{ "com_entry","",0,  NULL , NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL},
...
/*	fprintf(stderr, "Can't open default uumkey.%s\n" , CPFILE); */
  ...
  c_c->m_table = (MAIN_TABLE *)malloc(sizeof(MAIN_TABLE));
  for(j = 0 ; j < 3 ; j++){
/*
    for(k = 0; k < 32;k++){
...
{                
  ...
  */
    fprintf(stderr, "Key_binding file \"%s\" doesn't exist.\r\n",file_name);
    return(-1);
  }
  strcpy(dic_info->uumkey_name, file_name);
  ...
  */
  ...
  while(fgets(buf , 256 , fp)){
    ...
    if((com_cnt = sscanf(buf , "%s %s %s %s %s %s %s %s %s %s %s" , func_name , com_name[0],
      ...
      fprintf(stderr, "uumkey:file %s. Line %d is illegal.\r\n" ,file_name, lc);
...
char *st;
{
  ...
  if(num >= TBL_SIZE){
    fprintf(stderr, "uumkey: You can only bind a function to code less than %d.\r\n",
    	   TBL_SIZE);
    return(-1);
  }
  return(num);
