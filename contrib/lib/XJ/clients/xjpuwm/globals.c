 ...
 *
 *
 *	Original Source: ./clients/uwm/globals.c
 *
 *
 * Changes
...
#ifdef EUC
XJeFontStruct *IFontInfoEuc;	/* Icon text XJeFontStruct. */
XJeFontStruct *PFontInfoEuc;	/* Pop-up text XJeFontStruct. */
XJeFontStruct *MFontInfoEuc;	/* Menu text XJeFontStruct. */
#endif
#ifdef XJP
XJp_id	jpconvid = XJPID_INIT;
#endif
...
#ifdef EUC
char IFontNameStd[4][NAME_LEN];	/* Icon font name table */
char PFontNameStd[4][NAME_LEN];	/* Pop-up font name table */
char MFontNameStd[4][NAME_LEN];	/* Menu font name table */
char IFontNameExt[4][NAME_LEN];	/* Icon font name(extension) table */
char PFontNameExt[4][NAME_LEN];	/* Pop-up font name(extension) table */
char MFontNameExt[4][NAME_LEN];	/* Menu font name(extension) table */
#else
...
Keyword KeywordTable[] = {
...
#ifdef EUC
    { "iconfont",		IsString,	0,0,IFontNameStd[0],0 },
    { "iconfonteuc0",		IsString,	0,0,IFontNameStd[0],0 },
    { "iconfonteuc1",		IsString,	0,0,IFontNameStd[1],0 },
    { "iconfonteuc2",		IsString,	0,0,IFontNameStd[2],0 },
    { "iconfonteuc3",		IsString,	0,0,IFontNameStd[3],0 },
    { "iconfonteuc0ext",	IsString,	0,0,IFontNameExt[0],0 },
    { "iconfonteuc1ext",	IsString,	0,0,IFontNameExt[1],0 },
    { "iconfonteuc2ext",	IsString,	0,0,IFontNameExt[2],0 },
    { "iconfonteuc3ext",	IsString,	0,0,IFontNameExt[3],0 },
#else
    ...
    { "menu",		IsMenu,		0,0,0,0 },
#ifdef EUC
    { "menufont",		IsString,	0,0,MFontNameStd[0],0 },
    { "menufonteuc0",		IsString,	0,0,MFontNameStd[0],0 },
    { "menufonteuc1",		IsString,	0,0,MFontNameStd[1],0 },
    { "menufonteuc2",		IsString,	0,0,MFontNameStd[2],0 },
    { "menufonteuc3",		IsString,	0,0,MFontNameStd[3],0 },
    { "menufonteuc0ext",	IsString,	0,0,MFontNameExt[0],0 },
    { "menufonteuc1ext",	IsString,	0,0,MFontNameExt[1],0 },
    { "menufonteuc2ext",	IsString,	0,0,MFontNameExt[2],0 },
    { "menufonteuc3ext",	IsString,	0,0,MFontNameExt[3],0 },
#else
...
#ifdef EUC
    { "resizefont",		IsString,	0,0,PFontNameStd[0],0 },
    { "resizefonteuc0",		IsString,	0,0,PFontNameStd[0],0 },
    { "resizefonteuc1",		IsString,	0,0,PFontNameStd[1],0 },
    { "resizefonteuc2",		IsString,	0,0,PFontNameStd[2],0 },
    { "resizefonteuc3",		IsString,	0,0,PFontNameStd[3],0 },
    { "resizefonteuc0ext",	IsString,	0,0,PFontNameExt[0],0 },
    { "resizefonteuc1ext",	IsString,	0,0,PFontNameExt[1],0 },
    { "resizefonteuc2ext",	IsString,	0,0,PFontNameExt[2],0 },
    { "resizefonteuc3ext",	IsString,	0,0,PFontNameExt[3],0 },
#else
