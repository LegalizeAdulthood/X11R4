 ...
 *
 *
 * Original Source: ./clients/uwm/uwm.h
 *
 * Changes
...
#ifdef EUC
extern XJeFontStruct *IFontInfoEuc;	/* Icon text XJeFontStruct. */
extern XJeFontStruct *PFontInfoEuc;	/* Pop-up text XJeFontStruct. */
extern XJeFontStruct *MFontInfoEuc;	/* Menu text XJeFontStruct. */
#endif
...
#ifdef EUC
extern char IFontNameStd[4][NAME_LEN];	/* Icon font name table */
extern char PFontNameStd[4][NAME_LEN];	/* Pop-up font name table */
extern char MFontNameStd[4][NAME_LEN];	/* Menu font name table */
extern char IFontNameExt[4][NAME_LEN];	/* Icon font name(extension) table */
extern char PFontNameExt[4][NAME_LEN];	/* Pop-up font name(extension) table */
extern char MFontNameExt[4][NAME_LEN];	/* Menu font name(extension) table */
#else
