...
#ifndef lint
static char kterm_id[] = "$Header: convert.c,v 1.1 89/05/30 14:53:36 kagotani Rel $";
#endif /* lint */
...
/******************************************************************************
COMPOUND_TEXT Summary (Comopund Text Encoding Version 1 -- public review)
...
int jisroman;	/* if true, map YEN-mark etc.to right part of Latin-1 */
 ...
 */
{
	 ...
	 *  G0: ASCII
	 *  G1: KANJI / KANA / JIS-ROMAN emulation (8859/1 right part)
	 */
